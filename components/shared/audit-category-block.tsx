  ...
  return (
    <article className="surface-card space-y-5 p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="rounded-3xl border border-brand-100/80 bg-brand-50/62 px-4 py-3 text-center">
          <div className="text-3xl font-semibold text-slate-950">{score}</div>
          <div className="text-[11px] font-semibold tracking-[0.18em] text-brand-700 uppercase">
            Category score
          </div>
        </div>
      </div>

      <div className="rounded-3xl border border-slate-200/70 bg-slate-50/72 p-5">
